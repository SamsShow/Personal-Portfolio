      ...
      <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[23rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20 pb-14">
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          ...
          <div className="flex gap-3 mt-3">
            <a
            href={githubUrl}
            className="mt-auto text-sm text-gray-700 dark:text-white/70 hover:underline"><img className="w-auto h-7" src="/github.png" alt="github" />
            </a>
            <a
            href={ProjectUrl}
            className="mt-auto text-sm text-gray-700 dark:text-white/70 hover:underline"><img className="w-auto h-7" src="/start-up.png" alt="project" />
          </a>
          </div>
